...
export const Overlay = styled.div<BaseProps>`
  ${({ isOpen }) => css`
    visibility: hidden;
    opacity: 0;
...
//     ${!!disabled && BaseModifiers.disabled(theme)};
//     ${!!size && BaseModifiers[size]()};
//   `}
// `;
...
// export const Content = styled.div<BasePropsPick>`
